...
struct SearchView: View {
    ...
    func filterFiles() -> [FileData] {
        //TODO: - сначала выбираем по полному совпадению всей строки с наименованием, автором, именем файла. Потом разбираем строку поиска на слова и ищем в том же порядке, но уже по количеству совпадений от большего к меньшему
        if text.isEmpty {
            return []
        }
